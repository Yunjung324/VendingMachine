class VendingMachineEvents{
    ...
    bindEvent() {
         ...
         * 4. 입금액이 정상적으로 입금이 되면 입금창은 초기화 되어야한다.
         */
        ...
        /**
         * 2. 거스름돈 반환 버튼
         * 1) 반환 버튼을 누르면 소지금 === 소지금 + 잔액
         * 2) 반환 버튼을 누르면 잔액창이 초기화됩니다.
         */
         ...
         * 3) 아이템이 장바구니에 들어갑니다.
         * 4) 아이템의 count가 -1이 됩니다. 아이템의 카운트가 0이 되면 품절 표시하기
         */
